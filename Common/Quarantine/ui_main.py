...
################################################################################
## Form generated from reading UI file 'mainvhlPNx.ui'
##
...
class Ui_Fox2Av(object):
    def setupUi(self, Fox2Av):
        if Fox2Av.objectName():
            Fox2Av.setObjectName(u"Fox2Av")
        Fox2Av.resize(1100, 680)
        Fox2Av.setContextMenuPolicy(Qt.NoContextMenu)
        ...
        self.monitoring_mainFrame.setFrameShape(QFrame.StyledPanel)
        self.monitoring_mainFrame.setFrameShadow(QFrame.Raised)
...
"border: 3.5px solid rgb(91, 88, 111, 150);\n"
"border-radius: 10px;\n"
"padding: 4px 10px;")
        self.recentFrame.setFrameShape(QFrame.StyledPanel)
        self.recentFrame.setFrameShadow(QFrame.Raised)
...
"border-radius: 10px;\n"
"padding: 4px 10px;")
        self.sfInfoFrame.setFrameShape(QFrame.StyledPanel)
        self.sfInfoFrame.setFrameShadow(QFrame.Raised)
...
"border-radius: 10px;\n"
"padding: 4px 10px;")
        self.malDBInfoFrame.setFrameShape(QFrame.StyledPanel)
        self.malDBInfoFrame.setFrameShadow(QFrame.Raised)
...
"color: rgb(255, 255, 255);")
        ...
        self.txt_softwareInfo.setGeometry(QRect(20, 50, 771, 21))
        self.txt_softwareInfo.setStyleSheet(u"font: 15pt \"Consolas\";\n"
"color: rgb(255, 255, 255);")
        self.txt_softwareInfo_2 = QLabel(self.gb_softwareInfo)
        self.txt_softwareInfo_2.setObjectName(u"txt_softwareInfo_2")
        self.txt_softwareInfo_2.setEnabled(False)
        self.txt_softwareInfo_2.setGeometry(QRect(30, 80, 241, 21))
        self.txt_softwareInfo_2.setStyleSheet(u"font: 15pt \"Consolas\";\n"
"color: rgb(255, 255, 255);")
        ...
        self.Scan_mainFrame.setFrameShape(QFrame.StyledPanel)
        self.Scan_mainFrame.setFrameShadow(QFrame.Raised)
...
"")
        self.Frame_Targeted_Scan.setFrameShape(QFrame.StyledPanel)
        self.Frame_Targeted_Scan.setFrameShadow(QFrame.Raised)
...
"")
        self.Frame_Entire_Scan.setFrameShape(QFrame.StyledPanel)
        self.Frame_Entire_Scan.setFrameShadow(QFrame.Raised)
...
"padding: 4px 5px;")
        ...
        self.Frame_Custom_Scan.setFrameShape(QFrame.StyledPanel)
        self.Frame_Custom_Scan.setFrameShadow(QFrame.Raised)
...
"border-radius: 15px;")
        ...
        self._scan_set_targeted_frame.setFrameShape(QFrame.StyledPanel)
        self._scan_set_targeted_frame.setFrameShadow(QFrame.Raised)
...
"background-color: rgb(32, 41, 64);")
        ...
        self._scan_entire_frame.setFrameShape(QFrame.StyledPanel)
        self._scan_entire_frame.setFrameShadow(QFrame.Raised)
...
"}")
        self._scan_ent_processbar.setValue(24)
...
"padding: 4px 5px;")
        ...
        self._scan_targeted_frame.setFrameShape(QFrame.StyledPanel)
        self._scan_targeted_frame.setFrameShadow(QFrame.Raised)
...
"padding: 4px 5px;")
        ...
        self.rep_MainFrame.setFrameShape(QFrame.StyledPanel)
        self.rep_MainFrame.setFrameShadow(QFrame.Raised)
...
"padding: 4px 5px;")
        ...
        self.quarantine_MainFrame.setFrameShape(QFrame.StyledPanel)
        self.quarantine_MainFrame.setFrameShadow(QFrame.Raised)
...
"font: 13pt \"Consolas\";\n"
"color: rgb(255, 255, 255);")
        self.quarantine_table_widget.setEditTriggers(QAbstractItemView.NoEditTriggers)
...
"padding: 4px 10px;")
        ...
        self.lb_Monitoring.setGeometry(QRect(10, 70, 191, 131))
        self.lb_Monitoring.setStyleSheet(u"background-color: rgba(255, 255, 255, 0);")
        self.lb_Monitoring.setFrameShape(QFrame.StyledPanel)
        self.lb_Monitoring.setFrameShadow(QFrame.Raised)
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_Scan.setGeometry(QRect(10, 200, 191, 131))
        self.lb_Scan.setStyleSheet(u"background-color: rgb(25, 33, 53);")
        self.lb_Scan.setFrameShape(QFrame.StyledPanel)
        self.lb_Scan.setFrameShadow(QFrame.Raised)
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_Report.setGeometry(QRect(10, 330, 191, 131))
        self.lb_Report.setStyleSheet(u"background-color: rgb(25, 33, 53);")
        self.lb_Report.setFrameShape(QFrame.StyledPanel)
        self.lb_Report.setFrameShadow(QFrame.Raised)
...
"color: rgb(255, 255, 255);")
        ...
        self.lb_Quarantine.setGeometry(QRect(10, 460, 191, 131))
        self.lb_Quarantine.setStyleSheet(u"background-color: rgb(25, 33, 53);")
        self.lb_Quarantine.setFrameShape(QFrame.StyledPanel)
        self.lb_Quarantine.setFrameShadow(QFrame.Raised)
...
"color: rgb(255, 255, 255);")
        ...
        self.FoxVcMenu.setGeometry(QRect(0, 0, 1101, 61))
        self.FoxVcMenu.setStyleSheet(u"background-color: rgb(32, 41, 64);")
        self.FoxVcMenu.setFrameShape(QFrame.StyledPanel)
        self.FoxVcMenu.setFrameShadow(QFrame.Raised)
        self.fox2av_Name = QLabel(self.FoxVcMenu)
        self.fox2av_Name.setObjectName(u"fox2av_Name")
        self.fox2av_Name.setGeometry(QRect(60, 20, 101, 21))
...
"color: rgb(255, 255, 255);")
        ...
        self.fox2av_sub_Name.setGeometry(QRect(170, 30, 270, 16))
...
"color: rgb(255, 255, 255);")
        ...
        self.img_fox2av_logo.setGeometry(QRect(10, 10, 51, 41))
        ...
        self.sub_img_settings.setGeometry(QRect(860, 0, 31, 51))
        ...
        self.sub_txt_settings.setGeometry(QRect(890, 0, 81, 51))
...
"padding: 4px 5px;")
        ...
        self.sub_btn_settings.setGeometry(QRect(850, 0, 121, 61))
        ...
        self.sub_btn_minimalized.setGeometry(QRect(1020, 0, 41, 51))
...
"background-color: rgb(32, 41, 64, 0);")
    ...
    def retranslateUi(self, Fox2Av):
        ...
        self.txt_softwareInfo.setText(QCoreApplication.translate("Fox2Av", u"new Fox2Av version release !", None))
        self.txt_softwareInfo_2.setText(QCoreApplication.translate("Fox2Av", u"<html><head/><body><p><span style=\" color:#00ff00;\">-&gt; '</span><a href=\"https://github.com/miho030/Fox2Av\"><span style=\" font-weight:600; text-decoration: underline; color:#00ff00;\">Fox2Av 1.2.8-alpa</span></a><span style=\" color:#00ff00;\">'</span></p></body></html>", None))
